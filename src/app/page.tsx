  ...
  return (
    <main className="page-shell">
      ...
      <section className="hero-grid">
        <div className="hero-copy panel" data-reveal="left">
        ...
        <div className="hero-visual panel" data-reveal="right">
      ...
      <section className="logo-flow panel section-block-tight" data-reveal="fade">
      ...
      <section id="services" className="section-block">
        ...
        <div className="feature-grid">
          <article className="panel feature-card" data-reveal="left">
          ...
          <article className="panel feature-card" data-reveal="fade">
          ...
          <article className="panel feature-card" data-reveal="right">
      ...
      <section id="contact" className="section-block contact-banner panel" data-reveal="fade">
        <div>
